                ...
                link: function ($scope, $element) {
                    var windowEl = angular.element($window),
                        ...
                        init = function () {
                            ...
                            endPoint = getEndPoint();
                            updateMetrics();
                            windowEl.on('scroll', updateMetrics);
                            windowEl.on('touchmove', updateMetrics);
                    ...
                    $scope.$on('$destroy', function () {
                        windowEl.off('scroll', updateMetrics);
                        windowEl.off('touchmove', updateMetrics);
